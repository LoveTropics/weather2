...
public class ParticleCrossSection extends ParticleTexFX {
    ...
    public void render(VertexConsumer buffer, Camera renderInfo, float partialTicks) {
        ...
        buffer.addVertex(avector3f2[0].x(), avector3f2[0].y(), avector3f2[0].z()).setUv(f8, f6).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        buffer.addVertex(avector3f2[1].x(), avector3f2[1].y(), avector3f2[1].z()).setUv(f8, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        buffer.addVertex(avector3f2[2].x(), avector3f2[2].y(), avector3f2[2].z()).setUv(f7, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        buffer.addVertex(avector3f2[3].x(), avector3f2[3].y(), avector3f2[3].z()).setUv(f7, f6).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);

        buffer.addVertex(avector3f3[0].x(), avector3f3[0].y(), avector3f3[0].z()).setUv(f8, f6).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        buffer.addVertex(avector3f3[1].x(), avector3f3[1].y(), avector3f3[1].z()).setUv(f8, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        buffer.addVertex(avector3f3[2].x(), avector3f3[2].y(), avector3f3[2].z()).setUv(f7, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        buffer.addVertex(avector3f3[3].x(), avector3f3[3].y(), avector3f3[3].z()).setUv(f7, f6).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);

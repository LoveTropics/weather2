                ...
                if (true || mc.player.distanceTo(playerEntity) < 20) {
                    ...
                    while (curves.size() < 2) {
                        ...
                        for (int i = 0; i < vecs.length; i++) {
                            vecs[i] = new Vector3f(world.getRandom().nextFloat(), world.getRandom().nextFloat(), world.getRandom().nextFloat());
                        }
                    ...
                    /*if (bezierCurve != null) {
                        ...
                        for (int i = 0; i < bezierCurve.P.length; i++) {
                            bezierCurve.P[i].add((world.getRandom().nextFloat() - world.getRandom().nextFloat()) * randScale, (world.getRandom().nextFloat() - world.getRandom().nextFloat()) * randScale, (world.getRandom().nextFloat() - world.getRandom().nextFloat()) * randScale);
                    ...
                    if (bezierCurve != null && true) {
                        ...
                        for (int i = 0; i < bezierCurve.P.length; i++) {
                            if (vecSpeeds[i] == null) {
                                vecSpeeds[i] = new Vector3f(world.getRandom().nextFloat(), world.getRandom().nextFloat(), world.getRandom().nextFloat());
                            }
                            ...
                            if (bezierCurve.P[i].x() > maxXZ) {
                                vecSpeeds[i].set(world.getRandom().nextFloat() * -1 * randSpeed, vecSpeeds[i].y(), vecSpeeds[i].z());
                            } else if (bezierCurve.P[i].x() < minXZ) {
                                vecSpeeds[i].set(world.getRandom().nextFloat() * randSpeed, vecSpeeds[i].y(), vecSpeeds[i].z());
                            }
                            if (bezierCurve.P[i].y() > maxY) {
                                vecSpeeds[i].set(vecSpeeds[i].x(), world.getRandom().nextFloat() * -1 * randSpeed, vecSpeeds[i].z());
                            } else if (bezierCurve.P[i].y() < minY) {
                                vecSpeeds[i].set(vecSpeeds[i].x(), world.getRandom().nextFloat() * randSpeed, vecSpeeds[i].z());
                            }
                            if (bezierCurve.P[i].z() > maxXZ) {
                                vecSpeeds[i].set(vecSpeeds[i].x(), vecSpeeds[i].y(), world.getRandom().nextFloat() * -1 * randSpeed);
                            } else if (bezierCurve.P[i].z() < minXZ) {
                                vecSpeeds[i].set(vecSpeeds[i].x(), vecSpeeds[i].y(), world.getRandom().nextFloat() * randSpeed);
                            }
                            //bezierCurve.P[i].normalize();
                        }
